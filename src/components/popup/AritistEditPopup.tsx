...
const ArtistAbout = dynamic(
  () => import("../section/artist/artist_edit/ArtistAbout")
);
const ArtistRecognitions = dynamic(
  () => import("../section/artist/artist_edit/ArtistRecognitions")
);
const ArtistContact = dynamic(
  () => import("../section/artist/artist_edit/ArtistContact")
);
