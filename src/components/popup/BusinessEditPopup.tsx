...
const BusinessAbout = dynamic(
  () => import("../section/business/business-edit/BusinessAbout")
);
const BusinessServices = dynamic(
  () => import("../section/business/business-edit/BusinessServices")
);
const BusinessContact = dynamic(
  () => import("../section/business/business-edit/BusinessContact")
);
const BusinessMedia = dynamic(
  () => import("../section/business/business-edit/BusinessMedia")
);
