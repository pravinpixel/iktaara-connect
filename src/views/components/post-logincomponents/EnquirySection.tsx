          ...
          <Grid container>
                ...
                <Box>
                  ...
                  <Box>
                    <Stack direction={"row"} spacing={1}>
                      ...
                      <Box>
                        <Typography>Mahanadhi Shobana</Typography>
                        <Typography>Artist, Chennai</Typography>
                      </Box>
                    </Stack>
            ...
            <Grid item md={8}>
              ...
              <Box className="px-3 flex items-center justify-center">
                <Typography>Today, Aug 7, 2024</Typography>
              </Box>
              <Box className="bg-ik_white my-5 mx-2 rounded-[8px] p-3">
                {" "}
                <Box className="bg-ik_lightblue rounded-none rounded-br-[32px] rounded-bl-[32px] p-3 w-[400px] rounded-tr-[32px]">
                  ...
                  <Typography className="my-3">Hi Ramakrishna</Typography>
                  <Typography className="my-3">
                    Please visit our store at Anna Salai.
                  </Typography>
                  <Box>
                    {" "}
                    <Typography>Sachin Das </Typography>
                    <Typography> +91 98239 23989</Typography>
                  </Box>
                  <Box className="flex justify-end">
                    <Typography className="my-3">08:00</Typography>
                  </Box>
                </Box>
                <Box className="flex justify-end">
                  {" "}
